...
const CartPage = () => {
  ...
  return (
    <SinglePage title="Giỏ hàng">
      <Typography component="h2" fontWeight="700" my={2} textAlign="center" fontSize="20px">Thông tin đặt
        hàng</Typography>
      <Box>
      ...
      <HrTag p={2} />
      <Typography component="h2" fontWeight="700" mb={2} textAlign="center" fontSize="20px">Thông tin thanh
        toán</Typography>
      ...
      <Typography component="i" fontSize="16px">
        * Nếu số tiền thanh toán lớn hơn giá trị đơn hàng, phần thừa sẽ được cộng vào điểm mua hàng. Điểm mua hàng có
        thể sử dụng để mua sản phẩm.
      </Typography>
      {totalPriceCart > 0 && (
        <Box mt={2}>
          <TextField
      ...
      <HrTag p={2} />
      <Typography component="h2" fontWeight="700" mb={2} textAlign="center" fontSize="20px">Thông tin nhận
        hàng</Typography>
      <Box mb={1}>
      ...
      <HrTag p={2} />
      <Typography component="h2" fontWeight="700" mb={2} textAlign="center" fontSize="20px">Phương thức thanh
        toán</Typography>
      <Box>
        <RadioGroup
          row
      ...
      <Stack alignItems="center">
        <Button variant="contained" sx={{ width: "200px" }} onClick={gotoUploadImageBank} disabled={requesting}>Thanh
          toán</Button>
      </Stack>
      ...
      <Dialog open={modalOpen == "point"} sx={{ ".MuiDialog-container": { alignItems: "flex-start" } }}
        ...
        <DialogActions sx={{ justifyContent: "center" }}>
          ...
          <Button variant="contained" color="primary" disabled={requesting} onClick={() => submitOrderWithPointPay()}>Đặt
            hàng</Button>
        </DialogActions>
      </Dialog>
    </SinglePage>
