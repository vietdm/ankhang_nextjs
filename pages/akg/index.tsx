...
const AkgPage = () => {
    ...
    return (
        <SinglePage title="Điểm AKG">
            ...
            <Box paddingY={3}>
                <Typography variant="h5" textAlign="center" fontWeight={700} color="#037bc1" textTransform="uppercase">Chuyển điểm</Typography>
            </Box>
            <Stack>
                <TextField
                    size="small"
            ...
            <Box paddingY={3}>
                <Typography variant="h5" textAlign="center" fontWeight={700} color="#037bc1" textTransform="uppercase">Lịch sử Chuyển điểm</Typography>
            </Box>
