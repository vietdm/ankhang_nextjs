          ...
          <Fragment key={index}>
            <Box padding="15px" borderRadius="7px">
              ...
              <Stack direction="row" justifyContent="center">
                <Box width="250px">
                  {history.status === 0 && (
                    <Alert sx={{ justifyContent: "center" }} variant="standard" icon={false} severity="warning">Đang chờ
                      chấp thuận!</Alert>
                  )}
                  {history.status === 1 && (
                    <Alert sx={{ justifyContent: "center" }} variant="standard" icon={false} severity="info">Đã chấp
                      thuận!</Alert>
                  )}
                  {history.status === 2 && (
                    <Alert sx={{ justifyContent: "center" }} variant="standard" icon={false} severity="success">Rút
                      thành công!</Alert>
                  )}
                  {history.status === 3 && (
                    <Alert sx={{ justifyContent: "center" }} variant="standard" icon={false} severity="error">Từ
                      chối!</Alert>
                  )}
                </Box>
              </Stack>
