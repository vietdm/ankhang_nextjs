    ...
    return (
        ...
        >
            ...
            <svg className="loading_screen" viewBox="0 0 200 200" width="200" height="200" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle className="loading_screen__ring" cx="100" cy="100" r="82" fill="none" stroke="url(#loading_screen-grad1)" strokeWidth="36" strokeDasharray="0 257 1 257" strokeDashoffset="0.01" strokeLinecap="round" transform="rotate(-90,100,100)" />
                <line className="loading_screen__ball" stroke="url(#loading_screen-grad2)" x1="100" y1="18" x2="100.01" y2="182" strokeWidth="36" strokeDasharray="1 165" strokeLinecap="round" />
            </svg>
        </Stack>
    );
}
