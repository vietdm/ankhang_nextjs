...
export const HomeComponent = ({ active = false }: { active?: boolean }) => {
  ...
  return (
    <Box display={active ? "block" : "none"}>
      ...
      <Stack direction="row" flexWrap="wrap" justifyContent="center" maxHeight="calc(100% - 50px)" overflow="auto"
             marginTop={0}>
      ...
      <Stack direction="row" flexWrap="wrap" padding="5px" marginTop={2}>
        <BoxMenu>
          ...
          <Typography color="#0049a5" fontWeight="700" component="p" fontSize={16}
                      textAlign="right">{formatMoney(user?.reward_point)}</Typography>
        </BoxMenu>
        <BoxMenu>
          <Typography color="#0049a5" fontWeight="700" component="h4" fontSize={17}>Tổng hoa hồng</Typography>
          <Typography color="#0049a5" fontWeight="700" component="p" fontSize={16}
                      textAlign="right">{formatMoney(dashboardData?.money_bonus ?? 0)}</Typography>
        </BoxMenu>
        <BoxMenu>
          <Typography color="#0049a5" fontWeight="700" component="h4" fontSize={17}>Hoa hồng ngày</Typography>
          <Typography color="#0049a5" fontWeight="700" component="p" fontSize={16}
                      textAlign="right">{formatMoney(dashboardData?.money_bonus_day ?? 0)}</Typography>
        </BoxMenu>
        <BoxMenuLink link="/user/tree">
          <Typography color="#0049a5" fontWeight="700" component="h4" fontSize={17}>Tổng thành viên</Typography>
          <Typography color="#0049a5" fontWeight="700" component="p" fontSize={16}
                      textAlign="right">{dashboardData?.total_child}</Typography>
        </BoxMenuLink>
      </Stack>
